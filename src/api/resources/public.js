...
export function publicFolderList(params) {
  return request({
    url: listenClass + `/publicFolder/list`,
    method: 'get',
    params
  })
}
...
export function addFolder(data) {
  return request({
    url: listenClass + `/publicFolder/addFolder`,
    method: 'post',
    data
  })
}
...
export function addFile(data) {
  return request({
    url: listenClass + `/publicFolder/addFile`,
    method: 'post',
    data
  })
}
...
export function folderUpdate(data) {
  return request({
    url: listenClass + `/publicFolder/update`,
    method: 'post',
    data
  })
}
...
export function folderDelete(data) {
  return request({
    url: listenClass + `/publicFolder/delete`,
    method: 'post',
    data
  })
}
